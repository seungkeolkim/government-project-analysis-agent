...
사용자 원문의 "첫 admin: scripts/python/create_admin.py CLI" 요구사항을 구현한다.
...
실행 예:
    docker compose run --rm web python scripts/python/create_admin.py
    python scripts/python/create_admin.py root_user
    python scripts/python/create_admin.py root_user --email admin@example.com
...
def _build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python scripts/python/create_admin.py",
