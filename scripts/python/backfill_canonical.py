...
사용법:
    python scripts/python/backfill_canonical.py [--dry-run] [--batch-size N] [--db-url URL]
...
예시:
  ...
  # 임시 DB 로 검증
  python scripts/python/backfill_canonical.py --db-url sqlite:///./data/db/test_canonical.sqlite3 --batch-size 100
""",
    )
    parser.add_argument(
        "--dry-run",
