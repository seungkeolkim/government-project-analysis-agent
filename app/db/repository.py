...
설계 원칙:
    ...
    - 공고의 중복 판정 기준: (source_type, source_announcement_id) 복합 UNIQUE.
...
def upsert_announcement(session: Session, payload: Mapping[str, Any]) -> Announcement:
    ...
    동작:
        - (source_type, source_announcement_id) 로 기존 레코드를 찾는다.
    ...
    # (source_type, source_announcement_id) 복합 키로 기존 레코드 조회.
